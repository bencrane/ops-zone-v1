  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Import email accounts from a CSV file"
        actions={
          <Link
          ...
          {!parsedCSV ? (
            ...
            >
              ...
              <div className={`
                ...
                ${isDragging ? "bg-white text-black" : "bg-zinc-800 text-zinc-400"}
              `}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500">
                      {parsedCSV.rowCount} rows • {parsedCSV.headers.length} columns
                    </p>
                  </div>
                </div>
                <Button
                      ...
                      {parsedCSV.data.slice(0, 3).map((row, i) => (
                        <tr key={i} className="border-b border-zinc-800/50">
                          {parsedCSV.headers.map((header) => (
                            <td
                              key={header}
                              className="py-2 px-3 text-zinc-300 whitespace-nowrap max-w-[200px] truncate"
                            >
